---
layout: post
title: Como clonar regras de uma Security List
...
Então atualize a security list de destino com as regras contidas no arquivo egress.json, use o OCID da security list. 
