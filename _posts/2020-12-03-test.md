...
Recentemente a Oracle tornou disponivel o Private Access Channel (PAC) uma solução conectar o Oracle Analytics Cloud à fonte de dados privadas como Oracle Autonomous ADW, Oracle Autonomous ATP e DBSystem por exemplo.

Private Access Channel (PAC) é uma alternativa nativa ao Remote Data Gateway (RDG) e deve substitui-lo no futuro, mas atualmente algumas fontes de dados suportam apenas RDG. Importante destacar que RDG e PAC podem ser utilizados simultaneamente em uma mesma instancia do Oracle Analytics Cloud na OCI. 
...
Antes de prosseguir verifique NSG ou Security List da fonte de dados e adicione regras permitindo a acesso a partir dos endereços IPs do Private Access Channel (PAC).
