...
Vamos à um exemplo prático, uma empresa possue ambientes de desenvolvimento, homologação e produção, a produção deve ser operacional 24 horas por dia, já os ambientes desenvolvimento e homologação são utilizados apenas durante o horário comercial. Vamos simular os custos com e sem o desligamentos dos recursos durante os períodos ociosos.

| **Produção** | Custo |**Desenvolvimento** | Custo | **Homologação** | Custo |
| 5 VMs E3 4-OCPU/16RAM | Custo | Desenvolvimento | Custo | Homologação | Custo |
