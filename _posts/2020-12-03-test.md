...
Então atualize a security list de destino com as regras contidas no arquivo egress.json, use o OCID da security list de destino. Deve aparecer uma mensagem de WARNING solicitando para confirmar as alterações, digite **y** para confirmar.
...
Então atualize a security list de destino com as regras contidas no arquivo ingress.json, use o OCID da security list de destino. Deve aparecer uma mensagem de WARNING solicitando para confirmar as alterações, digite **y** para confirmar.
